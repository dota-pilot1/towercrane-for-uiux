...
import { documentPatchSchema, documentSchema, reorderSchema, titleSchema } from './architecture-playbook.schemas';
import { ArchitecturePlaybookService } from './architecture-playbook.service';

@Controller('architecture-playbook')
@UseGuards(SessionGuard)
export class ArchitecturePlaybookController {
  constructor(private readonly service: ArchitecturePlaybookService) {}
