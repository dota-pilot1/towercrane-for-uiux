...
import { documentPatchSchema, documentSchema, reorderSchema, titleSchema } from './sql-playbook.schemas';
import { SqlPlaybookService } from './sql-playbook.service';

@Controller('sql-playbook')
@UseGuards(SessionGuard)
export class SqlPlaybookController {
  constructor(private readonly service: SqlPlaybookService) {}
