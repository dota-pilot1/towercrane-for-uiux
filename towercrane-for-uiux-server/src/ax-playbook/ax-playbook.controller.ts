...
import { documentPatchSchema, documentSchema, reorderSchema, titleSchema } from './ax-playbook.schemas';
import { AxPlaybookService } from './ax-playbook.service';

@Controller('ax-playbook')
@UseGuards(SessionGuard)
export class AxPlaybookController {
  constructor(private readonly service: AxPlaybookService) {}
