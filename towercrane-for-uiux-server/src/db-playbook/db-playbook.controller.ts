...
import { documentPatchSchema, documentSchema, reorderSchema, titleSchema } from './db-playbook.schemas';
import { DbPlaybookService } from './db-playbook.service';

@Controller('db-playbook')
@UseGuards(SessionGuard)
export class DbPlaybookController {
  constructor(private readonly service: DbPlaybookService) {}
