...
import { documentPatchSchema, documentSchema, reorderSchema, titleSchema } from './technical-debt.schemas';
import { TechnicalDebtPlaybookService } from './technical-debt.service';

@Controller('skill-analysys')
@UseGuards(SessionGuard)
export class TechnicalDebtPlaybookController {
  constructor(private readonly service: TechnicalDebtPlaybookService) {}
