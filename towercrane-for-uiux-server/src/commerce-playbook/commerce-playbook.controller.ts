...
import { documentPatchSchema, documentSchema, reorderSchema, titleSchema } from './commerce-playbook.schemas';
import { CommercePlaybookService } from './commerce-playbook.service';

@Controller('commerce-playbook')
@UseGuards(SessionGuard)
export class CommercePlaybookController {
  constructor(private readonly service: CommercePlaybookService) {}
