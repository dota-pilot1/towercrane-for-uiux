...
import { documentPatchSchema, documentSchema, reorderSchema, titleSchema } from './cicd-playbook.schemas';
import { CicdPlaybookService } from './cicd-playbook.service';

@Controller('cicd-playbook')
@UseGuards(SessionGuard)
export class CicdPlaybookController {
  constructor(private readonly service: CicdPlaybookService) {}
