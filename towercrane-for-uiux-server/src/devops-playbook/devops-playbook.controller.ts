...
import { documentPatchSchema, documentSchema, reorderSchema, titleSchema } from './devops-playbook.schemas';
import { DevopsPlaybookService } from './devops-playbook.service';

@Controller('devops-playbook')
@UseGuards(SessionGuard)
export class DevopsPlaybookController {
  constructor(private readonly service: DevopsPlaybookService) {}
