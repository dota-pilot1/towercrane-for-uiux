...
const SQL_KEYWORD_OPTIONS = [
  ...
  { label: 'WITH', pattern: /\bWITH\b/i },
  { label: 'AS', pattern: /\bAS\b/i },
  { label: 'JOIN', pattern: /\b(?:LEFT|RIGHT|INNER|FULL|CROSS)?\s*JOIN\b/i },
  { label: 'LEFT JOIN', pattern: /\bLEFT\s+JOIN\b/i },
  ...
  { label: 'IN', pattern: /\bIN\s*\(/i },
  { label: 'NOT IN', pattern: /\bNOT\s+IN\b/i },
  { label: 'IS NULL', pattern: /\bIS\s+NULL\b/i },
  ...
  { label: 'DISTINCT', pattern: /\bDISTINCT\b/i },
  { label: 'UNION', pattern: /\bUNION\b/i },
] as const
