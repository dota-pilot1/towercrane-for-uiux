...
export const projectTaskExamples = defineExampleSet('04_project_task.sql', {
  beginner: [
    {
      id: '04_project_task.beginner.01',
      title: '고객사 목록',
...
ORDER BY id;`,
    ...
    {
      id: '04_project_task.beginner.02',
      title: '진행 중 프로젝트',
...
ORDER BY started_at;`,
    ...
    {
      id: '04_project_task.beginner.03',
      title: '멤버 역할별 인원',
...
ORDER BY member_count DESC;`,
    ...
    {
      id: '04_project_task.beginner.04',
      title: '마감 임박 업무',
...
LIMIT 3;`,
    ...
    {
      id: '04_project_task.beginner.05',
      title: '완료되지 않은 업무',
...
ORDER BY due_date;`,
    ...
    {
      id: '04_project_task.beginner.06',
      title: '우선순위별 업무 수',
...
ORDER BY task_count DESC;`,
    ...
    {
      id: '04_project_task.beginner.07',
      title: '업무 상태별 수',
...
ORDER BY task_count DESC;`,
    ...
    {
      id: '04_project_task.beginner.08',
      title: '프로젝트별 예상 시간',
...
ORDER BY total_estimate DESC;`,
    ...
    {
      id: '04_project_task.beginner.09',
      title: '최근 업무 댓글',
...
ORDER BY created_at DESC;`,
    ...
    {
      id: '04_project_task.beginner.10',
      title: '상태 변경 로그',
...
ORDER BY changed_at;`,
  ...
  intermediate: [
    {
      id: '04_project_task.intermediate.01',
      title: '프로젝트와 고객사',
...
ORDER BY p.started_at;`,
    ...
    {
      id: '04_project_task.intermediate.02',
      title: '프로젝트별 업무 수',
...
ORDER BY task_count DESC;`,
    ...
    {
      id: '04_project_task.intermediate.03',
      title: '멤버별 담당 업무 수',
...
ORDER BY assigned_tasks DESC;`,
    ...
    {
      id: '04_project_task.intermediate.04',
      title: '프로젝트 참여 멤버',
...
ORDER BY p.name, m.name;`,
    ...
    {
      id: '04_project_task.intermediate.05',
      title: '업무 담당자와 프로젝트',
...
ORDER BY p.name, t.due_date;`,
    ...
    {
      id: '04_project_task.intermediate.06',
      title: '댓글이 있는 업무',
...
ORDER BY comment_count DESC;`,
    ...
    {
      id: '04_project_task.intermediate.07',
      title: '상태 변경된 업무',
...
ORDER BY l.changed_at;`,
    ...
    {
      id: '04_project_task.intermediate.08',
      title: '고객사별 프로젝트 수',
...
ORDER BY project_count DESC;`,
    ...
    {
      id: '04_project_task.intermediate.09',
...
ORDER BY high_priority_count DESC;`,
    ...
    {
      id: '04_project_task.intermediate.10',
      title: '마감 지난 미완료 업무',
...
ORDER BY t.due_date;`,
  ...
  advanced: [
    {
      id: '04_project_task.advanced.01',
      title: '프로젝트별 진행률',
...
ORDER BY done_rate DESC;`,
    ...
    {
      id: '04_project_task.advanced.02',
      title: '담당자 없는 업무',
...
ORDER BY p.name;`,
    ...
    {
      id: '04_project_task.advanced.03',
      title: '참여하지 않는 멤버',
...
ORDER BY m.id;`,
    ...
    {
      id: '04_project_task.advanced.04',
...
ORDER BY p.name, estimate_rank;`,
    ...
    {
      id: '04_project_task.advanced.05',
      title: '멤버별 업무 부하',
...
ORDER BY total_hours DESC;`,
    ...
    {
      id: '04_project_task.advanced.06',
      title: '프로젝트별 댓글 활동',
...
ORDER BY comment_count DESC;`,
    ...
    {
      id: '04_project_task.advanced.07',
...
ORDER BY change_count DESC;`,
    ...
    {
      id: '04_project_task.advanced.08',
      title: '산업별 예상 업무 시간',
...
ORDER BY total_estimate DESC;`,
    ...
    {
      id: '04_project_task.advanced.09',
...
ORDER BY p.name;`,
    ...
    {
      id: '04_project_task.advanced.10',
      title: '업무 상태 전환 요약',
