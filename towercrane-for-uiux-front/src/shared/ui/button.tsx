  ...
  return (
    <button
      ...
      className={cn(
        ...
        variant === 'secondary' &&
          'border ui-surface-muted ui-text-primary hover:bg-(--surface-strong) [border-color:var(--interactive-border)]',
        variant === 'ghost' && 'ui-text-secondary hover:bg-(--surface-muted)',
