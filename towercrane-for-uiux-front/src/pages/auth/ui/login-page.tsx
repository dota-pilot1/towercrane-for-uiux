...
export function LoginPage() {
  ...
  return (
    <main className="mx-auto flex min-h-[calc(100vh-96px)] w-full max-w-[1040px] flex-col items-center justify-center gap-4 px-4 py-8">
      ...
      >
        <div
          className={`signin-panel absolute left-0 top-0 flex h-full w-full items-center justify-center bg-background px-6 py-10 transition-all duration-300 ease-in-out lg:w-1/2 lg:px-12 ${
        ...
        <div
          className={`signup-panel absolute left-0 top-0 flex h-full w-full items-center justify-center bg-background px-6 py-10 opacity-0 transition-all duration-300 ease-in-out lg:w-1/2 lg:px-12 ${
            isSignup ? 'z-20 opacity-100' : 'z-10'
          }`}
        >
  ...
  return (
    <div className="pointer-events-auto flex h-full w-1/2 flex-col items-center justify-center px-10 text-center text-text-primary">
      <div className="mb-8 w-full max-w-[340px] rounded-md border border-brand-border bg-background p-5 text-left shadow-[0_14px_34px_rgba(0,0,0,0.08)]">
        <div className="mb-4 flex items-center justify-between">
          <div className="flex min-w-0 items-center gap-2">
            ...
            <span className="min-w-0 text-xs font-black uppercase tracking-[0.18em] text-brand-primary">
              Dev Community
            </span>
          </div>
        ...
        <div className="grid gap-2">
          {['Prototype', 'Feedback', 'Build Notes'].map((item) => (
            <div
              key={item}
              className="flex items-center justify-between rounded-md border border-surface-border-soft bg-surface-raised px-4 py-2.5"
            >
      ...
      <Button
        type="button"
        variant="primary"
        className="mt-7 h-11 min-w-[160px] rounded-md px-6 text-sm shadow-[0_10px_24px_rgba(0,0,0,0.12)] hover:brightness-110 hover:-translate-y-0.5"
        onClick={onClick}
      >
        {buttonLabel}
      </Button>
